...
void insert_hash_table(struct hash_tablosu *hash_table,char *anahta){
    int hash_index = hash(anahta, hash_table->multiplier,
            hash_table->tablo_uzunlugu);
    if(insert(anahta,&((hash_table->tablo_basi +hash_index)->header)))
...
int main(int argc, char** argv) {
    ...
    insert_hash_table(htable,"besiktas");
    insert_hash_table(htable,"bakiray");
    insert_hash_table(htable,"beklava");
    print_hash_table(htable);
